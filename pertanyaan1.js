...
function cekjawaban1(){
    ...
    if(a.checked){
     document.getElementById("pembahasan1").innerHTML = '<div class="pembahasan">Jawabanmu <span style="color:#008000;"><b>Jawaban BENAR!</b></div>';
    }else {
    document.getElementById("pembahasan1").innerHTML = '<div class="pembahasan">Jawabanmu <span style="color:#DE3027;"><b>SALAH!</b></span> Silahkan jawab ulang!</div>';
    }
}
...
function cekjawaban2(){
    ...
    document.getElementById("pembahasan2").innerHTML = '<div class="pembahasan">Jawabanmu <span style="color:#DE3027;"><b>SALAH!</b></span> jawab ulang ya!</div>';
    }
}
