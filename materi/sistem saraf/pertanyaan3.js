...
function cekjawaban1(){
    ...
    document.getElementById("pembahasan1").innerHTML = '<div class="pembahasan">Jawabanmu <span style="color:#DE3027;"><b>SALAH!</b></span> Silahkan jawab kembali!</div>';
    }
}
...
function cekjawaban2(){
    ...
    document.getElementById("pembahasan2").innerHTML = '<div class="pembahasan">Jawabanmu <span style="color:#DE3027;"><b>SALAH!</b></span> Silahkan jawab kembali!</div>';
    }
}
